                        ...
                        <c:choose>
                            ...
                            <c:when test="${pageContext.request.userPrincipal.authenticated}">
                                <div class="lp-join-now">
                                    ...
                                    <a class=" md-trigger" data-modal="modal-3">Wyloguj!</a>
                                </div>
                            ...
                            <c:otherwise>
                                ...
                                <div class="lp-join-now">
                                    ...
                                    <a class=" md-trigger" data-modal="modal-3">Dołącz do nas!</a>
                                </div>
        ...
        <div class="md-modal md-effect-3" id="modal-3">
            <div class="login-form-popup lp-border-radius-8">
                <div class="siginincontainer">
                    <h1 class="text-center"><spring:message code="account.signin"/></h1>
                    <c:choose>
                    ...
                    <form class="form-horizontal margin-top-30" action="<c:url value='j_spring_security_check' />" name="f" method="post">
                    ...
                    <div class="pop-form-bottom">
                        <div class="bottom-links">
                            ...
                            <a  class="forgetPasswordClick pull-right" >Nie pamiętam hasła</a>
                        </div>
                ...
                <div class="siginupcontainer">
                    <h1 class="text-center"><spring:message code="account.register"/></h1>
                    <form:form commandName="account" class="form-horizontal margin-top-30">
                    <%--<form class="form-horizontal margin-top-30"  method="post">--%>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <p>Link aktywujący konto zostanie przesłany do Ciebie poprzez e-mail.</p>
                        </div>
                        <div class="form-group">
                            <input type="submit" value="Załóż konto" class="lp-secondary-btn width-full btn-first-hover" />
                        </div>
                    </form:form>
                    <div class="pop-form-bottom">
                        <div class="bottom-links">
                ...
                <div class="forgetpasswordcontainer">
                    ...
                    <form class="form-horizontal margin-top-30"  method="post">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Wyślij nowe hasło" class="lp-secondary-btn width-full btn-first-hover" />
                        </div>
                    </form>
                    <div class="pop-form-bottom">
                        <div class="bottom-links">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-xs-12 col-md-offset-2 col-sm-offset-0">
                            ...
                            <div class="text-center lp-search-description">
                                <p>Brak pomysłu? <br>
                                    skorzystaj z kategorii poniżej
                                </p>
